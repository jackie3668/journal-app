...
export const AchievementProvider = ({ children }) => {
  ...
  const fetchAchievements = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/achievements/${user.sub}` || `https://journal-app-backend-8szt.onrender.com/api/achievements/${user.sub}`);
  ...
  const updateAchievements = async (type, payload) => {
    ...
    try {
      ...
      ? `http://localhost:5000/api/achievements/${user.sub}` || `https://journal-app-backend-8szt.onrender.com/api/achievements/${user.sub}`
      : 'http://localhost:5000/api/achievements' || 'https://journal-app-backend-8szt.onrender.com/api/achievements';    
