...
const PromptUploader = () => {
  ...
  useEffect(() => {
    const fetchPrompts = async () => {
      try {
        const response = await axios.get('https://journal-app-backend-8szt.onrender.com/api/prompts' || 'https://journal-app-backend-8szt.onrender.com/api/prompts');
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post('https://journal-app-backend-8szt.onrender.com/api/prompts' || 'https://journal-app-backend-8szt.onrender.com/api/prompts', {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://journal-app-backend-8szt.onrender.com/api/prompts/${id}` || `https://journal-app-backend-8szt.onrender.com/api/prompts/${id}`);
