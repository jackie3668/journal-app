...
const PromptUploader = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post('http://https://journal-app-backend-8szt.onrender.com/api/prompts' || 'https://journal-app-backend-8szt.onrender.com/api/prompts', {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://https://journal-app-backend-8szt.onrender.com/api/prompts/${id}` || `https://journal-app-backend-8szt.onrender.com/api/prompts/${id}`);
