  ...
  const handleSave = async () => {
    ...
    try {
      const url = selectedEntryId
        ? (`https://journal-app-backend-8szt.onrender.com/api/entries/${selectedEntryId}` || `https://journal-app-backend-8szt.onrender.com/api/entries/${selectedEntryId}`)
        : (`https://journal-app-backend-8szt.onrender.com/api/entries` || 'https://journal-app-backend-8szt.onrender.com/api/entries');
